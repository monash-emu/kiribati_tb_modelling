...
Because screening can only reach the 85\% of the population classified as screening-reachable (Section~\ref{sec:reachability}), this represents the theoretical maximum population coverage. In practice, the scenarios labelled as ``85\% coverage'' are effectively implemented using 84.5\% coverage, corresponding to screening approximately 99.5\% of screening-reachable individuals in the eligible age groups. This small adjustment avoids requiring complete coverage of the screening-reachable population, which would require an infinite screening rate. The two lower levels represent incomplete participation among screening-reachable individuals.
