...
Table~\ref{tab-params} summarises the parameter definitions, values, and priors used in the model, while the following sections provide detailed descriptions and justifications for the parameter choices.
